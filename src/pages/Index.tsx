  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        <img 
          src="https://cdn.poehali.dev/files/3e230183-2f58-4e38-a963-be0300c0b76c.png" 
          alt="Детский сад" 
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+79001234567" className="text-muted-foreground hover:text-primary">+7 906 809-07-60</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Свердловская область, г. Полевской, мкр. Ялунина, зд. 22</p>
                    </div>
                  </div>
